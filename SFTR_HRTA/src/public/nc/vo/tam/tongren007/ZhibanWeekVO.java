...
public class ZhibanWeekVO extends SuperVO {
	...
	public String getPk_temp_old() {
		return pk_temp_old;
	}

	public void setPk_temp_old(String pk_temp_old) {
		this.pk_temp_old = pk_temp_old;
	}
	...
	public String getDeptnamekq() {
		return deptnamekq;
	}

	public void setDeptnamekq(String deptnamekq) {
		this.deptnamekq = deptnamekq;
	}
