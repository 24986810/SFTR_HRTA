package nc.ui.tam.tongren.basepower001;
...
//		" union all " +
		...
		" left join sm_userandclerk cl on cl.userid=sm.cuserid left join bd_psndoc psn on cl.pk_psndoc=psn.pk_psnbasdoc " +
				...
				"where role.pk_role in('00018L1000000010I65A','00018L1000000010I3WU','00018L1000000010ORY6') and sm.pk_corp in( '"+corp+"','0001','@@@@')  and nvl(locked_tag,'N')='N' order by nvl(deptname,user_name),user_code" ;
