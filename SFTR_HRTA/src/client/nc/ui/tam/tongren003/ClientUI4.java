 ...
 *
 */
public class ClientUI4 extends BillCardUI {
	...
	public ClientUI4() {
		...
		getBillCardPanel().getHeadItem("classtype").setEnabled(true);
...
//		UFDate end = curdate.getDateAfter(7-x);
		...
		getBillCardPanel().getHeadItem("classtype").setValue("3");
		...
		getBillCardPanel().getBillModel().setFixCol(3);
		
		getBillCardPanel().getBillModel().setSortColumn("psncode");
		
		EventHandler4 ev4 = (EventHandler4) createEventHandler(); 
		try {
			ev4.onBoAdd(getButtonManager().getButton(IBillButton.Add));
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
...
//		}
	 ...
	 * @param billId
	 */
	public ClientUI4(String pk_corp, String pk_billType, String pk_busitype,
	...
	protected ICardController createController() {
		...
		return new ClientCtrl4();
	}
	@Override
	protected CardEventHandler createEventHandler() {
		// TODO Auto-generated method stub
		return new EventHandler4(this,this.createController());
	}
...
//					
//					getButtonManager().getButton(804).setEnabled(false);
//					if(classtype.equals("1")){// 值班医务审核可以上传
//						getButtonManager().getButton(803).setEnabled(false);
//						getButtonManager().getButton(805).setEnabled(true);
//					}else{
//						getButtonManager().getButton(803).setEnabled(true);
