...
public class HrpTongrenDailyParaPanel extends UIPanel implements ItemListener, IParaPanel {

	private static final long serialVersionUID = 1L;
	
	private nc.ui.pub.beans.UIComboBox ivjUICmbTbmItem = null;
	private nc.ui.pub.beans.UILabel ivjlblItem = null;
	private String[] selkeys = new String[]{"ykdailyday"};//,"ykdailyday"
	private String[] selnames = new String[]{"累计是否三月缺勤"};//,"缺勤旷工天数"

	public HrpTongrenDailyParaPanel() {
		super();
		initialize();
	}
	/**
...
//		initData();
	 ...
	 * @param p0
	 */
	public HrpTongrenDailyParaPanel(LayoutManager p0) {
		super(p0);
	}
	 ...
	 * @param p0
	 */
	public HrpTongrenDailyParaPanel(boolean p0) {
		super(p0);
	}
	 ...
	 * @param p1
	 */
	public HrpTongrenDailyParaPanel(LayoutManager p0, boolean p1) {
		super(p0, p1);
	}
